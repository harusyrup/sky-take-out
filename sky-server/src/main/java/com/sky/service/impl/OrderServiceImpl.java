...
//        return vo;
    ...
    public OrderStatisticsVO statistics() {
        ...
        Long toBeConfirmed = orderMapper.getAmountByStatus(Orders.TO_BE_CONFIRMED);
        Long confirmed = orderMapper.getAmountByStatus(Orders.CONFIRMED);
        Long deliveryInProgress = orderMapper.getAmountByStatus(Orders.DELIVERY_IN_PROGRESS);
    ...
    public void finishOrder(Integer orderId) {
        // 根据id查询订单
        Orders ordersDB = orderMapper.getById((long)orderId);
    ...
    public OrderVO getOrderDetailById(Integer id) {
        ...
        orderVO.setId((long)id);
        Orders order = orderMapper.getById((long)id);
        List<OrderDetail> orderDetail = orderDetailMapper.getOrderDetail((long) id);
    ...
    public void deliveryOrder(Integer id) {
        // 根据id查询订单
        Orders ordersDB = orderMapper.getById((long)id);
